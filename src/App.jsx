...
function Home() {
  const words = ["Product Engineer", "Hot Sauce Enthusiast", "Tinkerer", "Writer", "Artist"];
      ...
      <div className="two-column-layout">
        ...
        <div className="column">
          ...
          <ul className="projects-list">
            <li><a href="https://remora-livid.vercel.app/">remora</a></li>
            <li><a href="https://www.loom.com/share/338830bbc54e4d7f8848f8091f87a1b3">workshop</a></li>
